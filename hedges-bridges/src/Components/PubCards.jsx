    ...
    <div className='pubContainer'>
      ...
      <div className='mainPublication'>
        ...
        <ul className='details mainDetails'>
          <li className='date'> <span className='dateIcon'><SlCalender/></span> <span> <strong>8/12/23</strong></span></li>
          <li>By: <strong>Jane Doe</strong></li>
        </ul>
        </div>

      <article>
        <h1>This is the Publication Title</h1>
